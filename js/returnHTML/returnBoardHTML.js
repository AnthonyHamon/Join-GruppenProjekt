...
<svg width="122" height="142" viewBox="0 0 102 122" fill="none" xmlns="http://www.w3.org/2000/svg">
    <!-- Hintergrundfarbe #2A3647 für die Füllanimation -->
    <rect width="102" height="122" fill="#2A3647"/>
    
    <!-- Maskendefinition -->
    <defs>
        <mask id="fill-mask">
            <!-- Maskenrechteck, welches animiert wird -->
            <rect x="0" y="122" width="102" height="122" fill="white">
                <animate attributeName="y" values="122;0" dur="2s" repeatCount="indefinite" />
            </rect>
        </mask>
    </defs>
    
    <!-- Weiße Pfade, die von der Maske abgedeckt werden -->
    <g mask="url(#fill-mask)">
        ...
        <path d="M39.1967 30.1318H17.0388V52.3884H39.1967V30.1318Z" fill="white"/>
